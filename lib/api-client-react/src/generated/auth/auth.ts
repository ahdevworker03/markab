...
export const getRegisterOrganizationMutationOptions = <
...
export type RegisterOrganizationMutationResult = NonNullable<
  Awaited<ReturnType<typeof registerOrganization>>
>;
...
export const getCurrentUser = async (
  options?: RequestInit,
): Promise<CurrentUserResponseWrapper> => {
...
export type ConfirmPasswordResetMutationBody =
  BodyType<ConfirmPasswordResetRequest>;
...
export const acceptEmployeeInvitation = async (
  acceptEmployeeInvitationRequest: AcceptEmployeeInvitationRequest,
  options?: RequestInit,
): Promise<AuthTokensResponse> => {
...
export const getAcceptEmployeeInvitationMutationOptions = <
  TError = ErrorType<ErrorResponse>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type AcceptEmployeeInvitationMutationResult = NonNullable<
  Awaited<ReturnType<typeof acceptEmployeeInvitation>>
>;
export type AcceptEmployeeInvitationMutationBody =
  BodyType<AcceptEmployeeInvitationRequest>;
