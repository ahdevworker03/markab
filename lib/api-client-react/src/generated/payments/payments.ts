 ...
 */
export const listRentalPayments = async (
  rentalId: string,
  options?: RequestInit,
): Promise<RentalPaymentsResponse> => {
  return customFetch<RentalPaymentsResponse>(
    getListRentalPaymentsUrl(rentalId),
    {
      ...options,
      method: "GET",
    },
...
export const getListRentalPaymentsQueryKey = (rentalId: string) => {
  return [`/api/rentals/${rentalId}/payments`] as const;
};

export const getListRentalPaymentsQueryOptions = <
  TData = Awaited<ReturnType<typeof listRentalPayments>>,
  TError = ErrorType<ErrorResponse>,
>(
  rentalId: string,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof listRentalPayments>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey =
    queryOptions?.queryKey ?? getListRentalPaymentsQueryKey(rentalId);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof listRentalPayments>>
  > = ({ signal }) =>
    listRentalPayments(rentalId, { signal, ...requestOptions });

  return {
    queryKey,
    queryFn,
    enabled: rentalId !== null && rentalId !== undefined,
    ...queryOptions,
  } as UseQueryOptions<
    Awaited<ReturnType<typeof listRentalPayments>>,
    TError,
...
export type ListRentalPaymentsQueryResult = NonNullable<
  Awaited<ReturnType<typeof listRentalPayments>>
>;
...
export function useListRentalPayments<
  TData = Awaited<ReturnType<typeof listRentalPayments>>,
  TError = ErrorType<ErrorResponse>,
>(
  rentalId: string,
...
export const createPayment = async (
  ...
  options?: RequestInit,
): Promise<PaymentResponseWrapper> => {
