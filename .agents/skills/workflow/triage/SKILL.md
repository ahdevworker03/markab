...
These are canonical role names. The actual label strings used in the issue tracker may differ. The mapping must be provided in the task context. If it is missing, ask the user for the mapping before changing issue state.
